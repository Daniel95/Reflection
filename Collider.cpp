...
bool Collider::CheckCollision(Collider& other, Vector2f &thisPush, Vector2f &otherPush) {
	...
	//Check the detla's between both colliders on both axises
	float deltaX = otherPosition.x - thisPosition.x;
	float deltaY = otherPosition.y - thisPosition.y;
	//Check by how mush they intersect
	...
	if (intersectX < 0.0f && intersectY < 0.0f) {
		...
		//Check on which axises they intersect, and push them out of eachother depending on the mass of the bodies
